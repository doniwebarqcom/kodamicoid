        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                <div class="top-left-part">
                    <!-- Logo -->
                    <a class="logo" href="{{ url('dropshiper') }}"><b>KODAMI Pocket System</b>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user animated flipInY">
                            ...
                            @if(\Session::get('is_login_admin'))
                                <li>
                                    <a href="{{ route('dropshiper.back-to-admin') }}"> <i class="fa fa-key"></i> Back to Admin</a>
                                </li>
                                <li role="separator" class="divider"></li>
                            @endif
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li> <a href="{{ url('dropshiper') }}" class="waves-effect active"><i class="mdi mdi-av-timer fa-fw" data-icon="v"></i> <span class="hide-menu"> Dashboard <span class="fa arrow"></span> <span class="label label-rouded label-inverse pull-right">4</span></span></a>
                    </li>
                    ...
                    <li class="last-nav"><a href="javascript:void(0)" class="waves-effect"><i class="mdi mdi-apps fa-fw"></i> <span class="hide-menu">Data Master<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            <li> <a href="{{ route('dropshiper.rekening-bank-user.index') }}" class="waves-effect"><i class="mdi mdi-calendar-check fa-fw"></i> <span class="hide-menu">Rekening Bank</span></a></li>
                        </ul>
                    </li>
                </ul>
            </div>
