                    ...
                    <div class="row row-in">
                        ...
                        <div class="col-lg-3 col-sm-6 row-in-br">
                            <ul class="col-in">
                                ...
                                <li class="col-last">
                                    <h3 class="counter text-right m-t-15">{{ $total_simpanan_sukarela }}</h3>
                                </li>
                                <li class="col-middle">
                        ...
                        <div class="col-lg-3 col-sm-6  b-0">
                            <ul class="col-in">
                                ...
                                <li class="col-last">
                                    <h3 class="counter text-right m-t-15">{{ $total_simpanan_wajib }}</h3>
                                </li>
                                <li class="col-middle">
                    ...
                    <div class="col-md-8 col-lg-9">
                        <div class="manage-users">
                            <div class="sttabs tabs-style-iconbox">
                                <nav>
                                    <ul>
                                        <li class="tab-current"><a href="#section-iconbox-1" class="sticon ti-user"><span>Users Activity</span></a></li>
                                        <li class=""><a href="#section-iconbox-2" class="sticon ti-lock"><span>Anggota Activity</span></a></li>
                                        <li class=""><a href="#section-iconbox-3" class="sticon ti-receipt"><span>Message Users</span></a></li>
                                    </ul>
                                </nav>
                                <div class="content-wrap">
                                    <section id="section-iconbox-1" class="">
                                        <div class="p-20 row">
                                            <div class="col-sm-6">
                                                <h3 class="m-t-0">User Activity</h3>
                                            </div>
                                            <div class="col-sm-6">
