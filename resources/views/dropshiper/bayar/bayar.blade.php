    ...
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <a href="{{ route('dropshiper.profile') }}" class="btn-info btn-circle pull-right m-l-20"><i class="ti-user text-white"></i></a>
                <ol class="breadcrumb">
                    <li><a href="{{ route('dropshiper.dashboard') }}">Home</a></li>
                        ...
                        <div class="tab-content col-md-7">
                            ...
                            <div id="tab-pembayaran" class="tab-pane">
                                <div class="white-box printableArea">
                                  <form method="post" id="form_payment" action="{{ route('dropshiper.bayar.submit') }}">
                                    {{ csrf_field() }}
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <form method="POST" action="{{ route('dropshiper.bayar.add-rekening-bank') }}" id="form-add-rekening">
