...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">SIMPANAN SUKARELA</h3><br />
                <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('dropshiper.simpanan-sukarela.store') }}" method="POST">
                    <div class="col-md-6">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="file" class="form-control" name="file_confirmation">
                            </div>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <hr />
                    <a href="{{ route('dropshiper.simpanan-sukarela.index') }}" class="btn btn-default waves-effect waves-light m-r-10 btn-sm"><i class="fa fa-arrow-left"></i> Back</a>
