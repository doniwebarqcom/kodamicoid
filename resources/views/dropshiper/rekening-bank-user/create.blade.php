    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="white-box">
                ...
                <br />
                <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('dropshiper.rekening-bank-user.store') }}" method="POST">
                    <div class="col-md-6">
                        {{ csrf_field() }}
                        ...
                        <a href="{{ url('dropshiper.rekening-bank-user.index') }}" class="btn btn-inverse waves-effect waves-light m-r-10">Cancel</a>
