        ...
        <div class="container-fluid">
            <div class="row bg-title">
                ...
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <a href="{{ route('dropshiper.profile')}}" class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">Profile</a>
                    <ol class="breadcrumb">
                        ...
                        <div class="p-30">
                            ...
                            <div class="row text-center m-t-30">
                                ...
                                <div class="col-xs-4 b-r">
                                    ...
                                    <a href="{{ route('dropshiper.simpanan-sukarela.index') }}" class="btn btn-default btn-xs"><i class="fa fa-search-plus"></i> detail</a>
                                </div>
                                <div class="col-xs-4 b-r">
                            ...
                            <div class="steamline">
                                <div class="sl-item">
                                    ...
                                    <div class="sl-right">
                                        ...
                                        <div class="desc">
                                            <form method="POST" action="{{ route('dropshiper.index.save.profile') }}" enctype="multipart/form-data">
                                                {{ csrf_field() }}
                                                <div class="col-md-6">
                                                    <div>
                                ...
                                <div class="sl-item">
                                    ...
                                    <div class="sl-right">
                                        <form action="{{ route('dropshiper.submit-step1') }}" method="POST">
                                        {{ csrf_field() }}
                                                            ...
                                                            <div class="pricing-box featured-plan">
                                                                <div class="pricing-body">
                                                                    ...
                                                                    <div class="price-table-content">
                                                                        <div class="price-row">
                                                                            <p>Transfer Ke</p>
                                                                            @if(isset($tagihan->rekening_bank->bank->image))
...
<div class="modal fade" id="upload_file_konfirmasi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
          <form method="POST" action="{{ route('dropshiper.upload.confirmation') }}" enctype="multipart/form-data">
